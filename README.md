...
| :-: | :-: | :-: | :-: | - | - |
| Traffic Speed | <div style="width: 4cm"> NAVER-Seoul  <br>  METR-LA  </div> |         PMPPPMemNet         | [Learning to Remember Patterns: Pattern Matching Memory Networks for Traffic Forecasting](https://openreview.net/forum?id=wwDg3bbYBIq) | [Pytorch](https://github.com/HyunWookL/PM-MemNet) | AAAI2022/A 
